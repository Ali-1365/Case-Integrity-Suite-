...
// ⚡ Bolt: Extracted QuotaDisplay to isolate frequent state updates (polling every 5s).
// This prevents the massive DocumentManager component from unnecessarily re-rendering
// across the entire application whenever the API status check fires.
