...
export const syntheticAnalysisResult: AnalysisResult = {
  ...
  atoms: [
    { id: "atom_100", documentId: "doc_001", position: 1, text: "Sökande i akut nöd – saknar medel för uppehälle.", keywords: ["akut nöd"], tags: ["nöd", "ekonomi"] },
    { id: "atom_150", documentId: "doc_001", position: 2, text: "Barnet riskerar att fara illa – ingen mat hemma.", keywords: ["barn", "matbrist"], tags: ["barn", "nödsituation"] },
    { id: "atom_520", documentId: "doc_001", position: 11, text: "Medvetet oriktiga sakuppgifter i journalen – bryter mot dokumentationsplikten (14 kap. 3 § SoL).", tags: ["LexSarah", "medvetet fel"] },
    { id: "atom_560", documentId: "doc_001", position: 15, text: "Ansvarsomkastning: barnet och föräldern lastas för konsekvenserna av kommunens underlåtenhet.", tags: ["ansvarsomkastning", "barnrätt"] },
    { id: "atom_570", documentId: "doc_002", position: 1, text: "Dokumenterad diskrepans mellan handläggarnas muntliga uttalanden och journalföring.", tags: ["motstridiga besked", "journalfusk"] },
    { id: "atom_580", documentId: "doc_003", position: 1, text: "CRPS-rehabilitering förhindrad p.g.a. ekonomisk skada och avstängd el/telefon.", tags: ["personskada", "CRPS"] },
    { id: "atom_590", documentId: "doc_001", position: 16, text: "Suicidtankar och förvärrad smärtproblematik till följd av nödsituationen.", tags: ["personskada", "suicidrisk"] },
    { id: "atom_600", documentId: "doc_004", position: 1, text: "Dom underkänner bilkravet som avslagsgrund – ingen verkställighet.", tags: ["dom", "utebliven verkställighet"] },
    { id: "atom_610", documentId: "doc_001", position: 17, text: "Handläggaren vägrar träffa besökaren/klaganden.", tags: ["vägran möte", "processfel"] },
    { id: "atom_620", documentId: "doc_001", position: 18, text: "El och telefon fortsatt avstängda – akut nödsituation förvärras.", tags: ["nödsituation", "avstängning"] },
    { id: "atom_630", documentId: "doc_003", position: 2, text: "Nervskada, sensibilitet borta i tå 2–4, fotled – sjukskrivning och handikapp.", tags: ["nervskada", "handikapp"] },
    { id: "atom_640", documentId: "doc_001", position: 19, text: "Krav på lagbrott från tjänstemän – bevisbördan cirkulär och omvänd.", tags: ["cirkulär bevisbörda", "tjänstefel"] },
    { id: "atom_700", documentId: "doc_005", position: 1, text: "Kronofogden inblandad – betalningsföreläggande p.g.a. kommunens underlåtenhet.", tags: ["Kronofogden", "skuldsättning"] },
    { id: "atom_710", documentId: "doc_001", position: 22, text: "Bilens förlorade värde och uppsägning p.g.a. obetald hyra – orsakad av kommunens fel.", tags: ["bilförlust", "ekonomisk skada"] },
    { id: "atom_720", documentId: "doc_003", position: 3, text: "ADHD-operation försenad p.g.a. ekonomisk kris och stress.", tags: ["ADHD", "försenad vård"] },
    { id: "atom_800", documentId: "doc_007", position: 1, text: "FL 5 § – saklighet och proportionalitet åsidosatt genom oriktiga uppgifter och oproportionerliga krav.", keywords: ["FL5", "saklighet"], tags: ["FL"] },
    { id: "atom_810", documentId: "doc_007", position: 2, text: "FL 6 § – serviceskyldighet grovt åsidosatt genom vägran att träffa i akut nödsituation.", keywords: ["FL6", "serviceskyldighet"], tags: ["FL"] },
    { id: "atom_820", documentId: "doc_007", position: 3, text: "FL 23 § – utredningsskyldighet underlåten trots dokumenterad barnrisk.", keywords: ["FL23", "utredningsskyldighet"], tags: ["FL"] },
    { id: "atom_830", documentId: "doc_007", position: 4, text: "FL 32 § – utebliven motivering vid muntliga avslag trots upprepad begäran.", keywords: ["FL32", "motivering"], tags: ["FL"] },
    { id: "atom_840", documentId: "doc_007", position: 5, text: "FL 16–18 §§ – jäv och underlåten jävsanmälan – opartiskhet ifrågasatt.", keywords: ["FL16-18", "jäv"], tags: ["FL"] },
    { id: "atom_850", documentId: "doc_007", position: 6, text: "FL 33 § – underlåten information om överklaganderätt.", keywords: ["FL33", "överklagande"], tags: ["FL"] }
  ],
