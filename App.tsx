  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans text-slate-900 dark:text-slate-100">
      ...
      <main className={`${topOffset} p-4 md:p-8 max-w-[1600px] mx-auto animate-in fade-in duration-500`}>
        ...
        {activeView === 'sfb' && <RequireAnalysis analysis={currentAnalysis}>{a => <SfbIntegrityPanel isOpen={true} onClose={() => handleNavigate('hubb')} analysis={a} />}</RequireAnalysis>}

        {/* SYSTEM */}
        {activeView === 'upload' && <DocumentManager onLogout={() => handleNavigate('hubb')} />}
