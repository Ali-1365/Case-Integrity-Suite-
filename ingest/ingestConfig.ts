...
export const INGEST_CONFIG: IngestItem[] = [
  ...
  { id: 'ysl_statlig_1977', sourceCode: 'YSL-S', sfsNumber: '1977:269', title: 'Lag om uppräkning av statliga yrkesskadelivräntor m.m.', rawFile: 'ysl_statlig_1977_269.txt', targetFile: 'ysl_statlig_1977_269.json', versionChain: ['1977:269'], validFrom: '1977-07-01' },
  { id: 'ysl_varde_1967', sourceCode: 'YSL-V', sfsNumber: '1967:919', title: 'Lag om värdesäkring av yrkesskadelivräntor m.m.', rawFile: 'ysl_varde_1967_919.txt', targetFile: 'ysl_varde_1967_919.json', versionChain: ['1967:919'], validFrom: '1968-01-01' },
  { id: 'yfo_statlig_1967', sourceCode: 'YFO-S', sfsNumber: '1967:920', title: 'Förordning om värdesäkring av yrkesskadelivräntor, som utgår av statsmedel, m.m.', rawFile: 'yfo_statlig_1967_920.txt', targetFile: 'yfo_statlig_1967_920.json', versionChain: ['1967:920'], validFrom: '1968-01-01' },
  ...
  { id: 'fhs_1995', sourceCode: 'FHS', sfsNumber: '1995:1301', title: 'Förordning om handläggning av skadeståndsanspråk mot staten', rawFile: 'fhs_1995_1301.txt', targetFile: 'fhs_1995_1301.json', versionChain: ['1995:1301'], validFrom: '1996-01-01' },
];
